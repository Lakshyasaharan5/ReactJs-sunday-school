import { studentObject, teacherDetails } from "../../../../Pages/InterfacesAndTypes";
...
export const viewStudent = (church:string,class_name:string)=>{
    return axios.get(`${SPRING_SERVER_BASE_URL}/viewteachers?church=${church}&class=${class_name}`)
}
export const editStudent = (studentObject:teacherDetails)=>{

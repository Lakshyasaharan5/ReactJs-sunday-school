  ...
  return (
        <>
            <header className="flex justify-between   sticky shadow-2xl p-1 bg-white ">
                ...
                {   props.userIcon ? 
                    <Link to="/sunday-school/profile" className="p-2">
                        <CgProfile 
                        style={{fontSize:"2rem"}}/>
                            ...
                            <main className=' flex flex-col text-start gap-8'>
                                <div className='flex'>
                                    ...
                                    <div className='px-4'>
                                        ...
                                        <Link to="/sunday-school/profile" className=' font-light'>View profile</Link>
                                    </div>
                                </div>
                                <div className='flex flex-col text-lg gap-5'>
                                    <div>
                                        <Link to="/sunday-school/"><p>Dashboard</p></Link>
                                    </div>

                                    { role==="user" ?
                                    <>
                                        <div>
                                            <Link to="/sunday-school/students"><p>My Students</p></Link>
                                        </div>
                                        <div>
                                            <Link to="/sunday-school/manageStudentAssessment"><p>Manage Assessment</p></Link> 
                                        </div>  
                                    </>:null}
                                    ...
                                    <>
                                        <div>
                                            <Link to="/sunday-school/managestudents"><p>Manage Students</p></Link>
                                        </div>
                                        <div>
                                            <Link to="/sunday-school/manageteachers"><p>Manage Teachers</p></Link>
                                        </div>
                                        <div>
                                            <Link to="/sunday-school/students"><p>Manage Student Assessments</p></Link>
                                        </div> 
                                    </>   
                                    : null}
                                    <div>

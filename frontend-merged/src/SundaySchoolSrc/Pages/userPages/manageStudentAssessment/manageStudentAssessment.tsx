                ...
                <div className='flex justify-center'>
                   ...
                   <div className='grid gap-4'>
                        ...
                        <div className="flex justify-between">
                            <Link to="/sunday-school/"><button className="bg-gray-500 hover:bg-gray-700 text-white font-sans font-semibold py-1 px-2 rounded" type="button">Back</button></Link>
